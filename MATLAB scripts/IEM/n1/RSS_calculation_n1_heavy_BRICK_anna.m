...
Mean_Measured_1=[-68.7480 -76.1121 -70.144 0 0 ]; % case1
Mean_Measured_2=[-68.0030 -81.7999 -82.1420 0 0]; %case2
...
%% Plots
figure
plot([1 2 3],Mean_Sim_1(1,1:3),'-s','MarkerFaceColor','b')
hold on
plot([1 2 3],Mean_Sim_1(2,1:3),'-rv','MarkerFaceColor','r')
plot([1 2 3],Mean_Sim_1(3,1:3),'-gx','MarkerFaceColor','g')
plot([1 2 3],Mean_Sim_1(4,1:3),'-mo','MarkerFaceColor','m')
...
title('Measured and Simulated Mean Values for different n1, case 1, BRICK')
hold off
...
figure
plot([1 2 3],Mean_Sim_2(1,1:3),'-s','MarkerFaceColor','b')
hold on
plot([1 2 3],Mean_Sim_2(2,1:3),'-rv','MarkerFaceColor','r')
plot([1 2 3],Mean_Sim_2(3,1:3),'-gx','MarkerFaceColor','g')
plot([1 2 3],Mean_Sim_2(4,1:3),'-mo','MarkerFaceColor','m')
plot([1 2 3],Mean_Measured_2,'-k+','MarkerFaceColor','k')
