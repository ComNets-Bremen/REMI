...
public class RssiMsg extends net.tinyos.message.Message {
    ...
    /** Create a new RssiMsg of size 9. */
    public RssiMsg() {
     ...
     */
    public int get_rssi() {
        return (int)getSIntBEElement(offsetBits_rssi(), 32);
    }
    ...
    public void set_rssi(int value) {
        setSIntBEElement(offsetBits_rssi(), 32, value);
    }
    ...
    /**
     * Return the value (as a int) of the field 'lqi'
     */
    public int get_lqi() {
        return (int)getUIntBEElement(offsetBits_lqi(), 16);
    }
    ...
    public void set_lqi(int value) {
        setUIntBEElement(offsetBits_lqi(), 16, value);
    }
